// ============================================
// DIALOGS.JS — Familie und Kultur: dialog animat
// Andreea (🇷🇴) ↔ Kenji (🇯🇵) · sync pe audio.currentTime + timer fallback
// Fără TTS (vocea Claudiei se înregistrează într-un singur MP3 cu pauze)
// ============================================

const dialog1Data = {
    id: 'dialog1',
    title: 'Andreea & Kenji — Familie in verschiedenen Kulturen',
    context: 'Doi studenți internaționali, Andreea (România) și Kenji (Japonia), discută într-o cafenea despre rolul familiei în culturile lor.',
    audioFile: 'audio/dialog-01.mp3',
    totalDuration: 92,
    replici: [
        { id: 1, speaker: 'andreea', start: 0,  duration: 16, de: 'Weißt du, in meiner Kultur ist die Großfamilie immer noch sehr wichtig. Wenn ich an meine Kindheit denke, dann sehe ich immer das Haus meiner Oma – voller Menschen, voller Lachen, voller Leben!', ro: 'Știi, în cultura mea familia extinsă este încă foarte importantă. Când mă gândesc la copilăria mea, îmi apare mereu casa bunicii – plină de oameni, de râsete, de viață!' },
        { id: 2, speaker: 'kenji',   start: 16, duration: 15, de: 'Das ist ja wirklich faszinierend! Wie ist das eigentlich bei euch in Rumänien – leben alle Generationen zusammen? Ich frage, weil das in Japan früher gang und gäbe war, sich aber stark verändert hat.', ro: 'Este fascinant! Cum stă treaba la voi în România – trăiesc toate generațiile împreună? Întreb, fiindcă în Japonia era altădată obișnuit, dar s-a schimbat mult.' },
        { id: 3, speaker: 'andreea', start: 31, duration: 16, de: 'Nicht mehr so oft, aber meine Eltern und Großeltern wohnen nah beieinander. Der Zusammenhalt ist uns sehr wichtig! Meine Großmutter erzählt immer von den Zeiten, als alle unter einem Dach lebten. Das ist heute Schnee von gestern...', ro: 'Nu chiar atât de des, dar părinții și bunicii mei locuiesc aproape. Coeziunea e foarte importantă! Bunica povestește mereu despre vremurile când toți trăiau sub același acoperiș. Azi, asta e apă trecută...' },
        { id: 4, speaker: 'kenji',   start: 47, duration: 16, de: 'Das klingt ganz anders als meine Erfahrung! Die Rollenverteilung hat sich sehr verändert. Ehrlich gesagt wünsche ich mir manchmal, dass wir diese Werte mehr bewahren könnten. Das berührt mich wirklich, weil der Generationskonflikt immer größer wird.', ro: 'Sună atât de diferit! Distribuția rolurilor s-a schimbat mult. Sincer, uneori mi-aș dori să putem păstra mai mult aceste valori. Mă emoționează, fiindcă conflictul dintre generații devine tot mai mare.' },
        { id: 5, speaker: 'andreea', start: 63, duration: 16, de: 'Ich verstehe, was du meinst, aber in meiner Kultur sehen wir das anders. Nicht alles, was glänzt, ist Gold – die Modernisierung bringt Freiheit, aber auch Einsamkeit. Es macht mich stolz zu wissen, dass meine Familie diese Werte noch lebt.', ro: 'Înțeleg ce vrei să spui, dar în cultura mea privim asta diferit. Nu tot ce strălucește e aur – modernizarea aduce libertate, dar și singurătate. Mă mândresc să știu că familia mea trăiește încă aceste valori.' },
        { id: 6, speaker: 'kenji',   start: 79, duration: 13, de: 'Da geht mir wirklich ein Licht auf! Ich habe das noch nie so betrachtet. Genau das habe ich auch erlebt – man strebt nach Unabhängigkeit und merkt plötzlich, was man verloren hat.', ro: 'Acum chiar mi-a picat fisa! Nu m-am gândit niciodată așa. Exact asta am trăit și eu – cauți independența și brusc îți dai seama ce ai pierdut.' }
    ]
};

const dialogsById = { dialog1: dialog1Data };

function speakerLabel(s) { return s === 'andreea' ? '🇷🇴 Andreea' : '🇯🇵 Kenji'; }
...
function avatarHTML(speaker) {
    ...
    return `<div class="character-avatar kenji-avatar">🎓</div>`;
}
        ...
        <div class="animated-dialog" id="dialog-${data.id}" data-dialog-id="${data.id}">
            ...
            <div class="stage-container">
                <div class="stage">
                    ...
                    <div class="character-wrapper character-kenji" data-speaker="kenji">
                        ${avatarHTML('kenji')}
                        <div class="character-label">Kenji 🇯🇵</div>
                        <div class="speech-bubble speech-kenji" id="bubble-${data.id}-kenji"><div class="bubble-de"></div><div class="bubble-ro"></div></div>
                    </div>
                </div>
