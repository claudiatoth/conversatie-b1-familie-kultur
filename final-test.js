// ============================================
// TEST FINAL - Familie und Kultur (Conversație B1-B2)
// Claudia Toth · 15 întrebări mixte
// ============================================

const finalTestData = [
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „die Großfamilie"?', options: ['familia nucleu', 'familia extinsă', 'familia recompusă', 'vecinii'], correct: 'familia extinsă', explanation: 'die Großfamilie = familia extinsă (mai multe generații împreună).' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „der Zusammenhalt"?', options: ['conflictul', 'coeziunea / solidaritatea', 'educația', 'tradiția'], correct: 'coeziunea / solidaritatea', explanation: 'der Zusammenhalt = coeziunea, sentimentul că familia rămâne unită.' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „die Gleichberechtigung"?', options: ['egalitatea de gen', 'autodeterminarea', 'așteptările', 'schimbarea'], correct: 'egalitatea de gen', explanation: 'die Gleichberechtigung = egalitatea (de drepturi/gen).' },
    { type: 'multiple', category: '📖 Vocabular', question: 'Was bedeutet „die Geborgenheit"?', options: ['conflictul', 'sentimentul de siguranță / căldura', 'distribuția rolurilor', 'libertatea'], correct: 'sentimentul de siguranță / căldura', explanation: 'die Geborgenheit = sentimentul de siguranță, căldura familiei.' },
    { type: 'multiple', category: '💬 Idiomuri', question: '„Das ist Schnee von gestern" bedeutet:', options: ['e ceva nou', 'nu mai e actual / relevant', 'e iarnă', 'e valoros'], correct: 'nu mai e actual / relevant', explanation: 'Schnee von gestern = apă trecută, nu mai e relevant.' },
    { type: 'multiple', category: '💬 Idiomuri', question: '„Da geht mir ein Licht auf" bedeutet:', options: ['mă enervez', 'înțeleg ceva brusc', 'mă întristez', 'plec'], correct: 'înțeleg ceva brusc', explanation: 'Mi-a picat fisa / m-a luminat — înțeleg brusc.' },
    { type: 'multiple', category: '💬 Idiomuri', question: '„Nicht alles, was glänzt, ist Gold" bedeutet:', options: ['totul e valoros', 'nu tot ce arată bine e cu adevărat valoros', 'aurul strălucește', 'nimic nu strălucește'], correct: 'nu tot ce arată bine e cu adevărat valoros', explanation: 'Aparența nu garantează valoarea.' },
    { type: 'multiple', category: '💬 Idiomuri', question: '„gang und gäbe" bedeutet:', options: ['rar', 'interzis', 'obișnuit / răspândit', 'modern'], correct: 'obișnuit / răspândit', explanation: 'gang und gäbe = üblich, weit verbreitet (obișnuit, general acceptat).' },
    { type: 'luckentext', category: '✍️ Vocabular activ', question: 'Completează:', sentence: 'Der familiäre ______ ist besonders in Krisenzeiten wichtig.', translation: 'Coeziunea familială e importantă în vremuri de criză.', accept: ['Zusammenhalt'], correct: 'Zusammenhalt', explanation: 'der Zusammenhalt = coeziunea.' },
    { type: 'luckentext', category: '✍️ Vocabular activ', question: 'Completează:', sentence: 'Die ______ zwischen Mann und Frau hat sich stark verändert.', translation: 'Distribuția rolurilor s-a schimbat mult.', accept: ['Rollenverteilung'], correct: 'Rollenverteilung', explanation: 'die Rollenverteilung = distribuția rolurilor.' },
    { type: 'luckentext', category: '✍️ Verb', question: 'Perfekt (prefix neseparabil):', sentence: 'Meine Familie hat die alten Werte ______. (bewahren)', translation: 'Familia mea a păstrat valorile vechi.', accept: ['bewahrt'], correct: 'bewahrt', explanation: 'be- neseparabil → Perfekt FĂRĂ ge-: bewahrt.' },
    { type: 'multiple', category: '🗣️ Fraze', question: 'Cum începi politicos o comparație culturală?', options: ['Halt die Klappe!', 'Weißt du, in meiner Kultur...', 'Das ist falsch.', 'Keine Ahnung.'], correct: 'Weißt du, in meiner Kultur...', explanation: 'Frază de deschidere caldă pentru a-ți prezenta perspectiva.' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Wie sieht Andreea die Familie in Rumänien?', options: ['Familia nu mai contează.', 'Familia extinsă e încă foarte importantă.', 'Toți locuiesc singuri.', 'Doar familia nucleu contează.'], correct: 'Familia extinsă e încă foarte importantă.', explanation: 'Andreea: „die Großfamilie ist immer noch sehr wichtig".' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Was hat sich laut Kenji in Japan verändert?', options: ['Nimic.', 'Distribuția rolurilor / conviețuirea generațiilor.', 'Limba.', 'Clima.'], correct: 'Distribuția rolurilor / conviețuirea generațiilor.', explanation: 'Kenji: „die Rollenverteilung hat sich sehr verändert".' },
    { type: 'multiple', category: '🎬 Dialog', question: 'Care e concluzia comună a celor doi?', options: ['Tradiția e mereu mai bună.', 'Modernitatea e mereu mai bună.', 'Un echilibru între tradiție și modernitate e important.', 'Familia nu contează.'], correct: 'Un echilibru între tradiție și modernitate e important.', explanation: 'Modernizarea aduce libertate, dar și singurătate — important e echilibrul.' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong>: vocabular, expresii idiomatice, fraze și înțelegerea dialogului.</p>
